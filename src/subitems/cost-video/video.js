...
// import styles from "./cost-video.module.scss"
import "./cost-video.scss"
...
export const Video = ( {mobileSrc , desktopSrc})=>{
  ...
  useEffect(()=>{
    ...
    const videoClass = videoSrc===mobileSrc? "main_video_mobile" :"main_video_disable ";
    const videoTemplate = `<video   src=${videoSrc} class=${videoClass}  
loop="true"  muted  playsinline  autoplay  width="100%" height="100%"></video>`

  return <div className="cost_video" dangerouslySetInnerHTML={{__html:videoTemplate}} />
}