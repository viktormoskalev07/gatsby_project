...
export const YouTobeReview = ( {  embed , title , param ="" , children  }) => {
  ...
  return (
    <div className={styles}>
      <button className="videoreview_button" style ={hide} onClick={start}>
        <div className="videoreview_button_symbol"></div>
      </button>
