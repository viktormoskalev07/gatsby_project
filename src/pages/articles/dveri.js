          ...
          <div class="content_body_absolute">
            <div class="left_sidebar">
              <ul>
                ...
                <li><AnchorLink to="/articles/dveri/#dveri_2" title="Другие варианты межкомнатных дверей" /></li>
                <li><AnchorLink to="/articles/dveri/#dveri_3" title="Что можно использовать вместо дверей?" /></li>
              </ul>
            </div>
          </div> 
          <div class="wrapper">
            <div class="right_content">
              <Fancybox>
                <div class="wrapper_article">
                  ...
                  <h2 class="content_h2" id="dveri_2">Другие варианты межкомнатных дверей</h2>
                  <div class="content_text">
                  ...
                  <div class="content_images">
                    <div class="content_images_two">
                      ...
                      <a
                        href="https://www.i-project.by/portfolio_newsite/korolya/3d/1.webp"
                        data-fancybox="gallery"
                      >
                        <StaticImage src="../../images/portfolio/korolya/3d/1.jpg" alt="" />
                      </a>
                    </div>
                  </div>
                  <div class="content_text">
                  ...
                  <h2 class="content_h2" id="dveri_3">Что можно использовать вместо дверей?</h2>
                  <div class="content_text">
