        ...
        <div class="content_body">
          <div class="content_body_absolute">
            <div class="left_sidebar">
              <ul>
                <li><AnchorLink to="/articles/obschaya-zona/#obschaya-zona_1" title="Организация гостиной" /></li>
                <li><AnchorLink to="/articles/obschaya-zona/#obschaya-zona_2" title="Организация кухни" /></li>
                <li><AnchorLink to="/articles/obschaya-zona/#obschaya-zona_3" title="Организация столовой" /></li>
              </ul>
            </div>
          </div> 
          <div class="wrapper">
              ...
              <Fancybox>
                <div class="wrapper_article">
                  <div class="content_text">
                    <p class="content_p">Совмещение гостиной, кухни и&nbsp;столовой&nbsp;&mdash; тренд последних лет, у&nbsp;которого множество преимуществ.</p>
                    <p class="content_p">Такое интерьерное решение позволяет не&nbsp;только грамотно использовать имеющееся жилое пространство, но&nbsp;и&nbsp;создавать комфортные условия для коммуникации между всеми членами семьи. Благодаря совмещению гостиной, кухни и&nbsp;столовой процесс приготовления еды из&nbsp;бытового процесса может быть превращен в&nbsp;приятный ритуал, в&nbsp;который могут быть вовлечены все члены семьи и&nbsp;их&nbsp;гости.</p>
                  </div>
                  ...
                  <div class="content_text">
                    <p class="content_p">Зачастую противники подобного интерьерного решения в&nbsp;качестве аргумента против него приводят неприятные запахи гари, которые будут долетать из&nbsp;кухни. Эта проблема сегодня решается при помощи мощных и&nbsp;функциональных вытяжных устройств, которые могут располагаться как над варочной панелью, так и&nbsp;быть интегрированными в&nbsp;саму варочную панель.</p>
                  </div>
                  <div class="content_images">
                    <div class="content_images_two">
                      <a
                  ...
                  <div class="content_text">
                    <p class="content_p">В&nbsp;большинстве квартир для того, чтобы организовать устройство электрической вытяжки, как правило, требуется задействовать вентшахту, предназначенную для естественной вентиляции. Правильнее было&nbsp;бы изначально проектировать в&nbsp;зоне кухни две вентшахты, но&nbsp;почему-то большая часть наших архитекторов, проектирующих многоквартирные жилые дома, об&nbsp;этом даже не&nbsp;задумывается. Не&nbsp;лишним в&nbsp;данной ситуации будет устройство отдельной приточно-вытяжной системы вентиляции, чтобы обеспечить постоянное поступление свежего воздуха.</p>
                  </div>
                  <div class="content_images">
                    <div class="content_images_two">
                      <a
                  ...
                  <div class="content_text">
                    <p class="content_p">Благодаря совмещению кухни, гостиной и&nbsp;столовой в&nbsp;квартире появляется зона, в&nbsp;создании общей композиции которой участвуют сразу несколько элементов: диванная, столовая и&nbsp;кухонная группы. При грамотном подходе они дополняют друг друга, делают пространство сложнее и&nbsp;интереснее.</p>
                  </div>
                  <div class="content_images">
                  ...
                  <div class="content_text">
                    <p class="content_p">Для создания гармоничного интерьера в&nbsp;совмещенной зоне есть ряд правил:</p>
                  </div>
                  <h2 class="content_h2" id="obschaya-zona_1">Организация гостиной</h2>
                  <ul class="content_list">
                    <li>&mdash;&nbsp;Если площадь помещения позволяет, диваны и&nbsp;кресла лучше не&nbsp;ставить вплотную к&nbsp;стене.</li>
                    <li>&mdash;&nbsp;Композиция из&nbsp;нескольких диванов или дивана и&nbsp;кресел (шезлонга) смотрится интереснее чем просто один диван.</li>
                    <li>&mdash;&nbsp;При размещении диванной группы нужно учитывать видовые точки и&nbsp;место установки телевизора (при его наличии).</li>
                    <li>&mdash;&nbsp;Отличным дополнением интерьера станут предметы искусства и&nbsp;арт объекты.</li>
                  </ul>
                  <div class="content_images">
                    <div class="content_images_two">
                      <a
                  ...
                  <h2 class="content_h2" id="obschaya-zona_2">Организация кухни</h2>
                  <ul class="content_list">
                  ...
                  <h2 class="content_h2" id="obschaya-zona_3">Организация столовой</h2>
                  <div class="content_images">
                    <div class="content_images_two">
                      <a
                  ...
                  <ul class="content_list">
                    <li>&mdash;&nbsp;Размер стола зависит от&nbsp;предпочтений хозяев, их&nbsp;образа жизни. Если в&nbsp;доме часто бывают гости, стол можно сделать раздвижным.</li>
                    <li>&mdash;&nbsp;Если площадь помещения позволяет, стол лучше не&nbsp;ставить к&nbsp;стене&nbsp;&mdash; идеально иметь возможность обойти его со&nbsp;всех сторон.</li>
                    <li>&mdash;&nbsp;Хорошо, когда стол находится недалеко от&nbsp;окна.</li>
                    <li>&mdash;&nbsp;Ковер хорошо смотрится не&nbsp;только под диванной группой, но&nbsp;и&nbsp;под столом. Важно, чтобы он&nbsp;был с&nbsp;минимальным ворсом или безворсовым. Если на&nbsp;полу в&nbsp;общей зоне находится не&nbsp;плитка, а&nbsp;доска, ковер также поможет избежать царапин от&nbsp;ножек стульев.</li>
                  </ul>
                  <div class="content_images">
                    <div class="content_images_one">
                      <a
