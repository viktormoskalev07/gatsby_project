  ...
  return (
    <Layout>
      <Seo  title={"Планировка квартиры. Основные правила | I-PROJECT"} description={"Выделим 6 рекомендаций для планировки квартиры от 90 м2. Сравним планировки реализованных квартир."}
            location={"https://i-project.by/articles/plan-apart"}
            image={"https://i-project.by/portfolio_newsite/articles/article_1-12.jpg"}/>
                  ...
                  <div class="content_images">
                    <div class="content_images_two">
                      ...
                      <a
                        ...
                        data-fancybox="gallery"
                      >
                        <StaticImage src="../../images/portfolio/apart_for_life/01_apart_for_life.jpg" alt="Интерьер квартиры, совмещенные кухня гостиная столовая" />
                      </a>
                    </div>
                  </div>
                  <div class="content_text">
                  ...
                  <div class="content_images">
                    <div class="content_images_two">
                      <a
                        ...
                        data-fancybox="gallery"
                      >
                        <StaticImage src="../../images/portfolio/akvamarin/04_akvamarin.jpg" alt="Интерьер квартиры, совмещенные кухня гостиная столовая" />
                      </a>
                      <a
                        href="https://i-project.by/portfolio_newsite/design_interier_2/06_design_interier_2.webp"
                        data-fancybox="gallery"
                      >
                        <StaticImage src="../../images/portfolio/design_interier_2/06_design_interier_2.jpg" alt="Интерьер квартиры, совмещенные кухня гостиная столовая" />
                      </a>
                    </div>
                  </div>
                  <div class="content_text">
                  ...
                  <div class="content_images">
                    <div class="content_images_one">
                      <a
                        ...
                        data-fancybox="gallery"
                      >
                        <StaticImage src="../../images/portfolio/sunny/09_sunny.jpg" alt="Коридор в частном доме с гардеробом" />
                      </a>
                    </div>
                  </div>
                  ...
                  <div class="content_images">
                    <div class="content_images_one">
                      <a
                        ...
                        data-fancybox="gallery"
                      >
                        <StaticImage src="../../images/portfolio/filimonova/08_filimonova.jpg" alt="Интерьер кухни с барной стойкой" />
                      </a>
                    </div>
                  </div>
                  <div class="content_text">
                  ...
                  <div class="content_images">
                    <div class="content_images_one">
                      <a
                        ...
                        data-fancybox="gallery"
                      >
                        <StaticImage src="../../images/portfolio/color/07_color.jpg" alt="Интерьер квартиры, совмещенные кухня гостиная столовая" />
                      </a>
                    </div>
                  </div>
                  <div class="content_text">
                  ...
                  <div class="content_images">
                    <div class="content_images_two">
                      <a
                        ...
                        data-fancybox="gallery"
                      >
                        <StaticImage src="../../images/portfolio/moskvina/01_moskvina.jpg" alt="Интерьер квартиры в пастельных тонах" />
                      </a>
                      <a
                        href="https://i-project.by/portfolio_newsite/kaskad/09_kaskad.webp"
                        data-fancybox="gallery"
                      >
                        <StaticImage src="../../images/portfolio/kaskad/09_kaskad.jpg" alt="Мастер-спальня с черным шкафом" />
                      </a>
                    </div>
                  </div>
                  <div class="content_text">
                  ...
                  <div class="content_images">
                    <div class="content_images_one">
                      <a
                        ...
                        data-fancybox="gallery"
                      >
                        <StaticImage src="../../images/portfolio/korolya/11_korolya.jpg" alt="Ванная в мастер-спальне с элегантной ванной" />
                      </a>
                    </div>
                  </div>
                  <ul class="content_list">
                  ...
                  <div class="content_images">
                    <div class="content_images_one">
                      <a
                        ...
                        data-fancybox="gallery"
                      >
                        <StaticImage src="../../images/portfolio/storojevskaya/30_storojevskaya.jpg" alt="Ванная в мастер-спальне с элегантной ванной" />
                      </a>
                    </div>
                  </div>
                  <ul class="content_list">
