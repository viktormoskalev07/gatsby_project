    ...
    <Layout>
      ...
      <Fancybox>
        <div class="wrapper">
          <div class="project">
            <BreadcrumbsInterier />
            <h1 class="project_title">Дизайн квартиры в&nbsp;миниполисе Каскад, 130м<sup>2</sup></h1>
          </div>
          ...
          <div class="wrapper">
            <div class="right_content">
              <div class="project_info">
                ...
                <p class="project_info_p">Локация: <span>ЖК&nbsp;&laquo;Каскад&raquo;, Минск</span></p>
              ...
              <div class="content_task_block">
                ...
                <div class="content_task">
                  ...
                  <p class="content_task_p">Как хорошо проснуться одному<br />
                    В&nbsp;своем веселом холостяцком &laquo;флете&raquo;<br />
                    И&nbsp;знать, что вам не&nbsp;нужно никому<br />
                    Давать отчеты, никому на&nbsp;свете!&quot;<br />
                    А.Вертинский</p>
                </div>
              </div>
