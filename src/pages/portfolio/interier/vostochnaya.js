    ...
    <Layout>
      ...
      <Fancybox>
        <div class="wrapper">
          <div class="project">
            <BreadcrumbsInterier />
            <h1 class="project_title">Дизайн квартиры на&nbsp;ул.Восточная, 80м<sup>2</sup></h1>
          </div>
            ...
            <div class="right_content">
              ...
              <div class="content_task_block">
                ...
                <div class="content_task">
                  ...
                  <p class="content_task_p">Интерьер небольшой квартиры для комфортного проживания 1-2&nbsp;человек.</p>
                </div>
              </div>
