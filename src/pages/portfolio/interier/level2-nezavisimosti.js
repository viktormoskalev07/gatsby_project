    ...
    <Layout>
      ...
      <Fancybox>
        <div class="wrapper">
          <div class="project">
            <BreadcrumbsInterier />
            <h1 class="project_title">Дизайн интерьера двухуровневой квартиры на&nbsp;пр. Независимости, 200м<sup>2</sup></h1>
          </div>
            ...
            <div class="right_content">
              ...
              <div class="content_task_block">
                ...
                <div class="content_task">
                  ...
                  <p class="content_task_p">Пентхаус в&nbsp;Минске. Интерьер. Перед нами стояла задача уйти от&nbsp;всего лишнего, оставив только самое необходимое&nbsp;&mdash; роскошь.</p>
                </div>
              </div>
...
export default level2Nezavisimosti;
