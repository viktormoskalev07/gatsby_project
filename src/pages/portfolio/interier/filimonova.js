    ...
    <Layout>
      ...
      <Fancybox>
        <div class="wrapper">
          <div class="project">
            <BreadcrumbsInterier />
            <h1 class="project_title">Дизайн квартиры на&nbsp;ул.Филимонова, 140м<sup>2</sup></h1>
          </div>
            ...
            <div class="right_content">
              ...
              <div class="content_task_block">
                ...
                <div class="content_task">
                  ...
                  <p class="content_task_p">Современнный интерьер в&nbsp;ЖК&nbsp;&laquo;Аквамарин&raquo;.</p>
                </div>
              </div>
