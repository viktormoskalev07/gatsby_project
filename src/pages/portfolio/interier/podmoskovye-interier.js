    ...
    <Layout>
      ...
      <Fancybox>
        <div class="wrapper">
          <div class="project">
            <BreadcrumbsInterier />
            <h1 class="project_title">Дом в&nbsp;Подмосковье. Интерьер, 300м<sup>2</sup></h1>
          </div>
            ...
            <div class="right_content">
              ...
              <div class="content_task_block">
                ...
                <div class="content_task">
                  ...
                  <p class="content_task_p">Для этого дома мы&nbsp;сами делали архитектуру, поэтому работать над созданием дизайна интерьера было легко и&nbsp;приятно.</p>
                </div>
              </div>
...
export default podmoskovyeInterier;
