    ...
    <Layout>
      ...
      <Fancybox>
        <div class="wrapper">
          <div class="project">
            <BreadcrumbsInterier />
            <h1 class="project_title">Реконструкция жилого дома в&nbsp;Минске, 300м<sup>2</sup></h1>
          </div>
            ...
            <div class="right_content">
              ...
              <div class="content_task_block">
                ...
                <div class="content_task">
                  ...
                  <p class="content_task_p">Интерьер+Экстерьер</p>
                </div>
              </div>
...
export default rekonstrukciyaDom;
