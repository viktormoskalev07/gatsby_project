    ...
    <Layout>
      ...
      <Fancybox>
        <div class="wrapper">
          <div class="project">
            <BreadcrumbsInterier />
            <h1 class="project_title">Дизайн интерьера на&nbsp;пр. Независимости, 150м<sup>2</sup></h1>
          </div>
        ...
        <div class="content_body">
          <div class="content_body_absolute">
            <div class="left_sidebar">
              <ul>
                <li><AnchorLink to="/portfolio/interier/nezavisimosti/#anchor_1" title="Описание проекта" /></li>
                <li><AnchorLink to="/portfolio/interier/nezavisimosti/#anchor_2" title="Планировка квартиры" /></li>
                <li><AnchorLink to="/portfolio/interier/nezavisimosti/#anchor_3" title="Гостиная" /></li>
                <li><AnchorLink to="/portfolio/interier/nezavisimosti/#anchor_4" title="Кухня" /></li>
                <li><AnchorLink to="/portfolio/interier/nezavisimosti/#anchor_5" title="Спальня" /></li>
                <li><AnchorLink to="/portfolio/interier/nezavisimosti/#anchor_6" title="Детская комната" /></li>
                <li><AnchorLink to="/portfolio/interier/nezavisimosti/#anchor_7" title="Прихожая" /></li>
                <li><AnchorLink to="/portfolio/interier/nezavisimosti/#anchor_8" title="Санузел" /></li>
              </ul>
            </div>
          </div>
          <div class="wrapper">
            <div class="right_content">
              ...
              <div class="content_task_block" id="anchor_1">
                ...
                <div class="content_task">
                  ...
                  <p class="content_task_p">Квартира для молодой семьи, в&nbsp;интерьере преобладают разные оттенки белого и&nbsp;серого с&nbsp;древесными нотами. При создании интерьера использован ряд нетривиальных решений, включая бодрую и&nbsp;ритмичную композиционную схему, согласно которой сформировано пространство.</p>
                </div>
              </div>
              ...
              <div class="content_text">
                ...
                <p class="content_p">Особенность общей зоны&nbsp;&mdash; закругленная наружная стена. Будет&nbsp;ли такая стена проблемой при создании комфортного интерьера зависит от&nbsp;того, как организовать расстановку мебели и&nbsp;оборудования. В&nbsp;данном случае она не&nbsp;помешала объединить кухню, гостиную и&nbsp;столовую и&nbsp;разместить необходимую мебель, в&nbsp;том числе, барную стойку и&nbsp;обеденный стол.</p>
              </div>
              <div class="content_images">
          ...
          <div class="wrapper">
            <div class="right_content">
              <div class="content_text">
                ...
                <p class="content_p">Детская спальня рассчитана на&nbsp;двух девочек&nbsp;&mdash; школьниц, поэтому здесь находятся две кровати, стол с&nbsp;двумя рабочими местами и&nbsp;вместительный шкаф.</p>
              </div>
              <div class="content_images">
                <div class="content_images_one">
                  <a
              ...
              <div class="content_text">
                ...
                <p class="content_p">Прихожая просторная и&nbsp;имеет при себе две отдельные гардеробные: взрослую и&nbsp;детскую, а&nbsp;также хозяйственное помещение/постирочную.</p>
              </div>
              <div class="content_images">
                <div class="content_images_one">
                  <a
              ...
              <div class="content_text">
                ...
                <p class="content_p">В&nbsp;соответствии с&nbsp;пожеланием заказчика в&nbsp;квартире спроектированы два санузла: гостевой и&nbsp;хозяйский. Первый&nbsp;&mdash; меньшего размера&nbsp;&mdash; находится рядом со&nbsp;входом. Второй&nbsp;&mdash; более просторный&nbsp;&mdash; ближе к&nbsp;общей зоне и&nbsp;спальням. Здесь расположена красивая островная ванна (под углом) и&nbsp;умывальник из&nbsp;композита.</p>
              </div>
              <div class="content_images">
                <div class="content_images_two">
                  <a
