    ...
    <Layout>
      ...
      <Fancybox>
        <div class="wrapper">
          <div class="project">
            <BreadcrumbsInterier />
            <h1 class="project_title">Дизайн интерьера дома в&nbsp;Минске, 200м<sup>2</sup></h1>
          </div>
            ...
            <div class="right_content">
              ...
              <div class="content_task_block">
                ...
                <div class="content_task">
                  ...
                  <p class="content_task_p">Современный интерьер для семьи из&nbsp;пяти человек..</p>
                </div>
              </div>
...
export default designInterier2;
