    ...
    <Layout>
      ...
      <Fancybox>
        <div class="wrapper">
          <div class="project">
            <BreadcrumbsInterier />
            <h1 class="project_title">Дизайн офисов в&nbsp;составе ЖК&nbsp;Байконур в&nbsp;г.Москва, 120м<sup>2</sup></h1>
          </div>
        ...
        <div class="content_body">
          <div class="content_body_absolute">
            <div class="left_sidebar">
              <ul>
                <li><AnchorLink to="/portfolio/interier/baikonur/#anchor_1" title="Описание проекта" /></li>
                <li><AnchorLink to="/portfolio/interier/baikonur/#anchor_2" title="План" /></li>
                <li><AnchorLink to="/portfolio/interier/baikonur/#anchor_3" title="Кабинет руководителя" /></li>
                <li><AnchorLink to="/portfolio/interier/baikonur/#anchor_4" title="Совмещенная зона с&nbsp;рабочими местами и&nbsp;мини-кухней" /></li>
                <li><AnchorLink to="/portfolio/interier/baikonur/#anchor_5" title="Переговорная с&nbsp;рабочими местами" /></li>
                <li><AnchorLink to="/portfolio/interier/baikonur/#anchor_6" title="Приемная" /></li>
              </ul>
            </div>
          </div>
          <div class="wrapper">
            <div class="right_content">
              <div class="project_info">
                ...
                <p class="project_info_p">Локация: <span>Москва, Россия</span></p>
              ...
              <div class="content_task_block" id="anchor_1">
                ...
                <div class="content_task">
                  ...
                  <p class="content_task_p">Офисный блок размещен на&nbsp;первых этажах высотного здания ЖК&nbsp;Байконур в&nbsp;Москве. Сложная геометрия исходного пространства с&nbsp;нерегулярно расставленными объемами шахт, стояков и&nbsp;колонн, не&nbsp;стала преградой для формирования удобного и&nbsp;эффективного офиса, c&nbsp;четким функциональным зонированием, правильной эргономикой и&nbsp;приятной атмосферой.</p>
                </div>
              </div>
