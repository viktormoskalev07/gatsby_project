    ...
    <Layout>
      ...
      <Fancybox>
        <div class="wrapper">
          <div class="project">
            <BreadcrumbsInterier />
            <h1 class="project_title">Дизайн интерьера квартиры в&nbsp;ЖК&nbsp;&laquo;Престижино&raquo;, 160м<sup>2</sup></h1>
          </div>
          ...
          <div class="wrapper">
            <div class="right_content">
              <div class="project_info">
                ...
                <p class="project_info_p">Локация: <span>ЖK&nbsp;&laquo;Престижино&raquo;, Минск</span></p>
              ...
              <div class="content_task_block">
                ...
                <div class="content_task">
                  ...
                  <p class="content_task_p">Объединение двух квартир в&nbsp;одну.</p>
                </div>
              </div>
